						...
						<div class="row p10">
							<div class="panel panel-default">
								 <div class="panel-heading w3-container w3-light-blue p10">
			  						<span class="dropdown">
			  					<a href="/warehouse/stockoutdetailController?page=export"><button type="button" class="btn w3-container w3-light-blue p-header-btn dropdown-toggle"> Export </button></a>	
										  <ul class="dropdown-menu p10">
										    <li class="w3-container w3-text-black w3-hover-blue w3-hover-text-white p10"><a href="/warehouse/stockoutdetailController?page=excelform">Merchanise</a></li>
										    <li class=divider></li>
...
#stockinSearch tbody tr:hover { background-color: skyblue; cursor:pointer;
									...
									<table id="stockinSearch"
										...
										IStock_outService  stock_outService= (IStock_outService) SpringBeanFactory
												.getBean("Stock_outService");
											   	...
											   	//alert(st+"  start"+et+" end");
									  				...
									  				document.getElementById("edid").value=et;
										...
										List<StockoutDetail> stdList1=stockoutdetailService.selectOrder();
										...
										<tbody>
											...
											for (StockoutDetail stock : stdList1) {
													for(Stock_out s:stockoutList){
											%>
											<tr>
												<%
