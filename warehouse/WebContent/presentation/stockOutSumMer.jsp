	...
	<%@include file="header.jsp" %>
					<script type="text/javascript">
						function selectMerchandise(){
							...
							location.href="/warehouse/stockoutdetailController?page=filterMerchandise&merchandiseid="+merchandise;
						}
					</script>
						...
						<div class="row p10">
							<div class="panel panel-default">
						  		<div class="w3-container p10 row">
						  			<div class="col-sm-6"><h4>Stock Out Detail Information</h4></div>
...
<div class="panel-body p10">
				<!-- for body part of the body column -->
		  			...
		  			<%List<StockoutDetail> stock_outdetaillist=(List<StockoutDetail>)request.getAttribute("stockoutdetail"); %>
		  			...
		  			<table id="example"  class="table table-condensed table-bordered p10">
						...
						<%for(StockoutDetail sout:stock_outdetaillist){
							Merchandise m=(Merchandise)merchandiseService.selectMerchandise(sout.getMerchandise_id());%>
							<tr>
