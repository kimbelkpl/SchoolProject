...
<body class="w3-container w3-light-gray" onload="insertWarehouseValue('<%out.print(request.getAttribute("merchandiseID"));%>')">
	<%@include file="header.jsp" %>
					<script type="text/javascript">
						function selectWarehouse(){
							var merchandise=document.getElementById("cbomerchandise").value;
							location.href="/warehouse/StockBalanceController?page=filterMerchandise&merchandiseid="+merchandise;
						}
					</script>
						...
						<div class="row p10">
							<div class="panel panel-default">
						  		<div class="w3-container p10 row">
						  			...
						  			<div class="col-sm-3">
						  				<select class="form-control" id="cbomerchandise" name="cbomerchandise" onchange="selectWarehouse()">
...
<div class="panel-body p10">
				<!-- for body part of the body column -->
		  			...
		  			<%List<Stock_Balance> stock_balancelist=(List<Stock_Balance>)request.getAttribute("stockBalanceList"); %>
...
function merchandise(){
	if(request.getAttribute("")==arguments[0])
}
</script>
